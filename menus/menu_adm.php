            ...
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="admindex.php?link=1"><i class="fa fa-home fa-fw"></i> Principal</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-edit fa-fw"></i> Cadastro<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admindex.php?link=2"><i class="fa fa-users fa-fw"></i> Usuário</a>
                                </li>
                                <li>
                                    <a href="admindex.php?link=3"><i class="fa fa-print fa-fw"></i> Setor</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
