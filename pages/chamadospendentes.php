				...
				<div class="panel-body">
					<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
						...
						require "../arquivos/conexao.php";
							...
							$sqlchamadossetor=$pdo->prepare("SELECT * FROM tb_chamado WHERE id_UsuarioAutor = ? AND status = 'Aberto' OR status = 'Em análise' OR status = 'Reaberto' OR status = 'Observação'");
